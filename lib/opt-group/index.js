...
var OptGroup = function (_React$Component) {
    ...
    _createClass(OptGroup, [{
        ...
        value: function render() {
            ...
            var activeValue = _props.activeValue;
            var onClick = _props.onClick;
            var searchValue = _props.searchValue;

            var others = _objectWithoutProperties(_props, ['className', 'children', 'value', 'activeValue', 'onClick', 'searchValue']);

            var classes = (0, _classnames2.default)(_defineProperty({
                'lib-pc-select-lib-opt-group': true,
                'mobile': true,
                'phone': true
            }, className, className));
